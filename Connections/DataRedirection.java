...
public class DataRedirection {
	// clears a given directory with the address of that directory provided as a
	// parameter
	static void clearDirectory(String directory) {
		String files;
		File file = new File(directory);
		File[] listOfFiles = file.listFiles(); // array to store all the files
	...
	static void clearSpecificFile(String file) throws FileNotFoundException {
		...
		System.setOut(ps);
		System.out.println(""); // inserts a blank String into the directory to
								// replace existing content
		System.setOut(console);
	}

	// appends text (as a String) to a file. Each String appended goes to a new
	// line in the file
	static void appendTextToFile(String input, String location)
	...
	// this sends text (as a String) to a file but each instance of it erases
	// any previous content in the file
